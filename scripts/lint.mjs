...
const packageFiles = [
  ...
  'packages/irs-xml/package.json',
  'packages/irs-practitioner/package.json',
  'packages/refund-release-core/package.json',
  ...
  'services/apple-developer-console/package.json',
  'services/irs-practitioner-service/package.json',
  ...
  'workflows/refund-release-workflow/package.json',
  'engines/refund-optimization-engine/package.json',
