...
const requiredPaths = [
  ...
  'tools/ross-infinite/bin/ross.mjs',
  'tools/ross-infinite/package.json',
  'tools/ross-infinite/NOTICE',
  'tools/ross-infinite/src/cli.mjs',
  'tools/ross-infinite/config/seo/ross.co.ownership.json',
  'config/seo/ross.co.ownership.json',
  'docs/ross-infinite/README.md',
  'docs/rossco-seo-ownership.md',
  'docs/rossco-seo-dns-token-deploy.md',
  ...
  'workflows/production-activation-workflow/package.json',
  ...
  'packages/secrets-config/package.json',
  'packages/secrets-config/src/index.mjs',
  'docs/security-platform.md',
  'services/security-status-service/package.json',
  'services/security-status-service/src/index.mjs',
  'workers/security-scanner-worker/package.json',
